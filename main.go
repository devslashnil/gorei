...
// TODO: linters and install all
// TODO: rewrite all comments
// TODO: add tests
// TODO: add linters
// TODO: add functions as Cloud analogue

// Update is a Tg object that the handler receives every time an user interacts with the bot.
type Update struct {
...
func HandleTgWebHook(w http.ResponseWriter, r *http.Request, updHandler func(upd string) string) {
